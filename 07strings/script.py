...
daily_saves_replaced = daily_sales.replace(";,;", ":")
#print(daily_saves_replaced)
...
daily_transactions = daily_saves_replaced.split(",")
...
for index in transactions_clean:
  customers.append(index[0])
  sales.append(index[1])
  thread_sold.append(index[2])
...
for color in colors:
  print('The Thread Shed sold {} thread of {} thread today.'.format(color_count(color),color))