...
class Menu:
  ...
  def __repr__(self):
    return "{name} menu is available from {start_time}am to {end_time}pm".format(name = self.name, start_time = self.start_time, end_time = self.end_time)
...
print(brunch)
print(brunch.calculate_bills({"pancakes", "home fries", "coffee"}))
...
arepa_menu = Menu("Arepa", arepa_items, 1000, 2000)
